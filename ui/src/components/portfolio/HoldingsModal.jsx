  ...
  useEffect(() => {
    if (editingHolding) {
      ...
      setFormData({
        ...
        buyDate:
          editingHolding.buyDate || new Date().toISOString().split("T")[0],
      });
    } else {
      setFormData({
        assetClass: "IND_EQUITY",
      ...
      >
        ...
        >
          ...
          >
            ...
            {["IND_EQUITY", "US_EQUITY", "MF", "CRYPTO", "ESOP"].includes(
              formData.assetClass,
            ) && (
              <div>
          ...
          <div>
            <label style={labelStyle}>
              {["BANK", "CREDIT_CARD"].includes(formData.assetClass)
            ...
            <input
              ...
              style={inputStyle}
              placeholder={
                ["BANK"].includes(formData.assetClass)
                  ? "e.g. HDFC Savings"
          ...
          {[
            ...
            <div>
              <label style={labelStyle}>
                {formData.assetClass === "CREDIT_CARD"
                  ? "Current Outstanding Balance (Enter as Negative Number)"
