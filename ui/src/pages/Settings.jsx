...
export default function Settings() {
  ...
  const currentConfig = family?.config || {
    baseCurrency: "INR",
    ...
    >
      ...
      >
        <div>
          ...
          >
            <SettingsIcon size={24} color="var(--accent-gold)" /> Master
            Configuration
          </h1>
          <p style={{ color: "var(--text-muted)", marginTop: 4 }}>
            Configure taxation logic and localization for the family dashboard.
          </p>
        </div>
        <button
          onClick={handleSave}
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <select
            ...
            onChange={(e) =>
              setConfig({ ...config, baseCurrency: e.target.value })
            }
            style={{
          ...
          <p style={{ fontSize: 12, color: "var(--text-muted)", marginTop: 4 }}>
            Used to aggregate total portfolio value.
          </p>
        </div>
      </section>
      ...
      >
              ...
              <div>
                ...
                <div style={{ position: "relative" }}>
                  <input
                    ...
                    onChange={(e) =>
                      handleTaxChange("indiaSTCG", e.target.value)
                    }
                    style={{
                      background: "var(--surface-3)",
                      color: "var(--text-primary)",
              ...
              <div>
                ...
                <div style={{ position: "relative" }}>
                  <input
                    ...
                    onChange={(e) =>
                      handleTaxChange("indiaLTCG", e.target.value)
                    }
                    style={{
                      background: "var(--surface-3)",
                      color: "var(--text-primary)",
        ...
        >
          <Info
            size={16}
            style={{ flexShrink: 0, marginTop: 2, color: "var(--accent-blue)" }}
          />
          <div>
            Holding period classification is calculated dynamically per holding
            based on its Buy Date. Indian assets default to 365 days for LTCG.
          </div>
        </div>
      </section>
    </div>
