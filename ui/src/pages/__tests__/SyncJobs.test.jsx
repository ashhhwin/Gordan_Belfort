...
describe("SyncJobs Component", () => {
  ...
  it("renders loading state and fetches data successfully", async () => {
    ...
    const mockLogs = [
      {
        id: "1",
        job_name: "Portfolio Sync",
        status: "SUCCESS",
        started_at: "2026-06-17T19:00:00Z",
        completed_at: "2026-06-17T19:05:00Z",
        message: "Success",
      },
      {
        id: "2",
        job_name: "NSE Market Data",
        status: "FAILED",
        started_at: "2026-06-17T17:00:00Z",
        completed_at: "2026-06-17T17:01:00Z",
    ...
    axios.get.mockImplementation((url) => {
      if (url.includes("cron-status"))
        return Promise.resolve({ data: mockCronStatus });
    ...
    await waitFor(async () => {
      const portfolioSyncElements =
        await screen.findAllByText("Portfolio Sync");
